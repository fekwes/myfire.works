...
const CSV_COLUMNS: {
  ...
  { header: "ISA", value: (y) => Math.round(y.isaBalanceEnd) },
  { header: "GIA", value: (y) => Math.round(y.giaBalanceEnd) },
  { header: "SIPP", value: (y) => Math.round(y.sippBalanceEnd) },
  { header: "Rental value", value: (y) => Math.round(y.rentalValueEnd) },
  { header: "Home value", value: (y) => Math.round(y.homeValueEnd) },
  { header: "ISA withdrawal", value: (y) => Math.round(y.isaWithdrawal) },
  { header: "GIA withdrawal", value: (y) => Math.round(y.giaWithdrawal) },
  { header: "SIPP gross", value: (y) => Math.round(y.sippGrossWithdrawal) },
